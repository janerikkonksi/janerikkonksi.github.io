...
if ( ! class_exists( 'Astra_Theme_Extension' ) ) {
	...
	class Astra_Theme_Extension {
		...
		public function enable_disable_file_generation() {
			...
			if ( false !== $status ) {
				Astra_Admin_Helper::update_admin_settings_option( '_astra_file_generation', $status, true );
				wp_send_json_success();
			}
		...
		public function astra_refresh_assets_files() {
			...
			$allow_file_generation = Astra_Admin_Helper::get_admin_settings_option( '_astra_file_generation', true, 'disable' );
